...
train_set <- read.table("C:\\Users\\vsn\\Desktop\\data\\UCI HAR Dataset/train/X_train.txt")  
test_set <- read.table("C:\\Users\\vsn\\Desktop\\data\\UCI HAR Dataset/test/X_test.txt")
train_label <- read.table("C:\\Users\\vsn\\Desktop\\data\\UCI HAR Dataset/train/y_train.txt")
test_label <- read.table("C:\\Users\\vsn\\Desktop\\data\\UCI HAR Dataset/test/y_test.txt")
train_subject <- read.table("C:\\Users\\vsn\\Desktop\\data\\UCI HAR Dataset/train/subject_train.txt")
test_subject <- read.table("C:\\Users\\vsn\\Desktop\\data\\UCI HAR Dataset/test/subject_test.txt")
